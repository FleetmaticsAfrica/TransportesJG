...
<main id="skip_content" role="main">
    <div class="container">
        <div class="main-wrapper">
            ...
            if($transport_movers_layout_option == 'Left Sidebar'){ ?>
                <div class="row">
                                ...
                                <div class="entry-content">
                                    ...
                                    <div class="entry-attachment">
                                        <div class="attachment">
                                            <?php transport_movers_the_attached_image(); ?>
                                        </div>
                                        <?php if ( has_excerpt() ) : ?>
                                    ...
                                    <?php
                                        the_content();
                                        wp_link_pages( array(
                                            'before' => '<div class="page-links">' . __( 'Pages:', 'transport-movers' ),
                                            'after'  => '</div>',
                                        ) );
                                    ?>
                                </div>    
                                <?php edit_post_link( __( 'Edit', 'transport-movers' ), '<footer class="entry-meta" role="contentinfo"><span class="edit-link">', '</span></footer>' ); ?>
                            </article>    
                            <?php
            ...
            <?php }else if($transport_movers_layout_option == 'One Column'){ ?>
                    <?php while ( have_posts() ) : the_post(); ?>    
                        <article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
                            <div class="entry-content">
                                <h1><?php the_title(); ?></h1>    
